		...
		<div class="container-fluid">
			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					...
					<c:set var="novedad" scope="request" value = "${requestScope.novedad}"/>
						<form method="post" action="NovedadController?ed=<c:out value="${novedad != null ? novedad.idNovedad: 0}"/>">
							<div class="row">
									...
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input type="text" name="id" class="form-control" readonly="readonly"
												value="<c:out value = "${novedad.idNovedad}"/>" required>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input type="text" name="titulo" class="form-control"
												value="<c:out value = "${novedad.titulo}"/>" required>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="input-group">
											...
											<textarea class="form-control" rows="4" name="descripcion"
												required><c:out value = "${novedad.descripcion}"/></textarea>
										</div>
									</div>
								</div>
							</div>
